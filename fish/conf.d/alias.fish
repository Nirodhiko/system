...
# emerge
abbr -a es -- sudo emerge --search
abbr -a ei -- sudo emerge --ask
abbr -a eib -- sudo emerge --ask --getbinpkg
abbr -a ed -- sudo emerge --deselect
abbr -a eq -- sudo equery u
abbr -a edep -- sudo equery d
abbr -a eu -- sudo emerge --ask --update --deep --newuse @world --exclude grub --exclude vivaldi
abbr -a euc -- sudo emerge --ask --verbose --changed-use --update --deep @world
abbr -a ecu -- sudo cfg-update -u
abbr -a ec -- sudo emerge --ask --depclean
abbr -a el -- sudo qlist -IRv
abbr -a en -- sudo eselect news read
abbr -a ef -- sudo emerge --info \| grep ^USE
abbr -a efd -- less /var/db/repos/gentoo/profiles/use.desc
